export default {
  ...
  enemies: [
    ...
    { id: "warlord_grask", weight: 0.001, loot: [{ itemId: "shatterbone_warhelm", dropRate: 0.30 }, { itemId: "orcish_cleaver_heavy", dropRate: 0.20 }, { itemId: "grask_totem", dropRate: 0.25 }] },
