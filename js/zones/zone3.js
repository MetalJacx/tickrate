export default {
  ...
  enemies: [
    ...
    { id: "bonecrusher", weight: 0.13, loot: [{ itemId: "bonecrusher_maul", dropRate: 0.24 }] },
    { id: "skullsplitter", weight: 0.13, loot: [{ itemId: "skullsplitter_axe", dropRate: 0.26 }] },
    { id: "shaman_grimtooth", weight: 0.092, loot: [{ itemId: "grimtooth_fetish", dropRate: 0.20 }, { itemId: "grimtooth_staff", dropRate: 0.18 }] },
    { id: "captain_boneclaw", weight: 0.092, loot: [{ itemId: "boneclaw_pauldrons", dropRate: 0.18 }, { itemId: "boneclaw_blade", dropRate: 0.16 }] },
  ...
  subAreas: [
    { id: "open_world", name: "Open World", discovered: true, discoveryChance: 0, mobWeightModifiers: { warlord_grask: 0, bonecrusher: 0, skullsplitter: 0, shaman_grimtooth: 0, captain_boneclaw: 0 } },
    {
      id: "outer_barricades",
      ...
      mobWeightModifiers: { 
        shatterbone_scout: 1.4, 
        shatterbone_legionary: 0.9, 
        shatterbone_brute: 0.7, 
        warlord_grask: 0,
        bonecrusher: 280,
        skullsplitter: 270,
        shaman_grimtooth: 0,
    ...
    },
    {
      ...
      mobWeightModifiers: { 
        shatterbone_legionary: 1.3, 
        shatterbone_brute: 1.1, 
        shatterbone_scout: 0.8, 
        warlord_grask: 300,
        bonecrusher: 0,
        skullsplitter: 0,
        shaman_grimtooth: 260,
        captain_boneclaw: 270
      }
    }
  ]
};
