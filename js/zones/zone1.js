export default {
  ...
  enemies: [
    ...
    { id: "phantom", weight: 0.001, loot: [{ itemId: "phantom_essence", dropRate: 0.30 }] },
    { id: "groundskeeper", weight: 0.001, loot: [{ itemId: "groundskeeper_haft", dropRate: 0.22 }, { itemId: "gravebinder_wraps", dropRate: 0.20 }] },
  ...
  subAreas: [
    {
      ...
      discovered: true,
      discoveryChance: 0,
      mobWeightModifiers: { phantom: 0, groundskeeper: 0 }
    },
    {
      id: "open_graves",
      name: "Open Graves",
