export default {
  ...
  enemies: [
    ...
    { id: "bone_king", weight: 0.0, rare: true, loot: [{ itemId: "enchanted_branch", dropRate: 0.22 }] }
  ],
  subAreas: [
    { id: "open_world", name: "Open World", discovered: true, discoveryChance: 0, mobWeightModifiers: {} },
    { id: "lower_halls", name: "Lower Halls", discovered: false, discoveryChance: 0.02, mobWeightModifiers: { hallowbone_warpriest: 1.2, bone_king: 0.05 } },
    { id: "throne_of_bone", name: "Throne of Bone", discovered: false, discoveryChance: 0.01, mobWeightModifiers: { hallowbone_warpriest: 1.0, bone_king: 0.15 } }
  ]
};
